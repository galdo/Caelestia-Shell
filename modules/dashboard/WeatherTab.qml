    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                StyledText {
                    text: Weather.city || Tr.t("Loading...")
                ...
                StyledRect {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            ...
                            text: forecastItem.index === 0 ? Tr.t("Today") : new Date(forecastItem.modelData.date).toLocaleDateString(Qt.locale(), "ddd")
                            font: Tokens.font.body.builders.medium.weight(Font.DemiBold).build()
                            color: Colours.palette.m3primary
                        }
