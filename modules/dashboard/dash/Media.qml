...
Item {
    ...
    StyledText {
        ...
        text: (Players.active?.trackTitle ?? Tr.t("No media")) || Tr.t("Unknown title")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackAlbum ?? Tr.t("No media")) || Tr.t("Unknown album")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackArtist ?? Tr.t("No media")) || Tr.t("Unknown artist")
