        ...
        Repeater {
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    Layout.alignment: Qt.AlignHCenter
                    text: hour.index === 0 ? Tr.t("Now") : Qt.formatDateTime(new Date(hour.cond.timestamp.replace("T", " ")), GlobalConfig.services.useTwelveHourClock ? "ha" : "hh:00")
