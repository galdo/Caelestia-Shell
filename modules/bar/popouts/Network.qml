...
ColumnLayout {
    ...
    StyledText {
        ...
        Layout.rightMargin: Tokens.padding.extraSmall
        text: Tr.t("%1 networks available").arg(Nmcli.networks.length) // qmllint disable missing-property
    ...
    StyledText {
        ...
        Layout.topMargin: visible ? Tokens.spacing.small : 0
        Layout.rightMargin: Tokens.padding.extraSmall
        text: Tr.t("%1 devices available").arg(Nmcli.ethernetDevices.length)
        color: Colours.palette.m3onSurfaceVariant
        font: Tokens.font.body.small
    }
    ...
    Repeater {
        ...
        RowLayout {
            ...
            StyledText {
                ...
                Layout.rightMargin: Tokens.spacing.extraSmall
                Layout.fillWidth: true
                text: ethernetItem.modelData.iface || Tr.t("Unknown")
                elide: Text.ElideRight
