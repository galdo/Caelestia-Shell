...
PageBase {
    ...
    ColumnLayout {
        ...
        StepperRow {
            first: true
            label: Tr.t("Shown")
            subtext: Tr.t("Number of workspaces displayed")
        ...
        ToggleRow {
            last: true
            text: Tr.t("Per-monitor workspaces")
            subtext: Tr.t("Show each monitor's workspaces independently")
